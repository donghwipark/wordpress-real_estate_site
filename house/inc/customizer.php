<?php
/**
 * Eastlead Global House Theme Customizer
 *
...
add_action( 'customize_register', 'house_customize_register' );
...
function house_customize_preview_js() {
	wp_enqueue_script( 'house-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
